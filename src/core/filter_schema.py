...
CONDITION_SCHEMA: dict[str, FieldDef] = {
    "AreaLevel":    FieldDef("AreaLevel",    "區域等級",   FieldType.INT_OP,  SECTION_CONDITIONS, 1,   100),
    "ItemLevel":    FieldDef("ItemLevel",    "物品等級",   FieldType.INT_OP,  SECTION_CONDITIONS, 0,   100),
    "DropLevel":    FieldDef("DropLevel",    "掉落等級",   FieldType.INT_OP,  SECTION_CONDITIONS, 0,   100),
    "Quality":      FieldDef("Quality",      "品質",       FieldType.INT_OP,  SECTION_CONDITIONS, 0,   30),
    "Rarity":       FieldDef("Rarity",       "稀有度",     FieldType.ENUM,    SECTION_CONDITIONS, options=RARITY_OPTIONS),
    "Class":        FieldDef("Class",        "物品類別",   FieldType.STRING,  SECTION_CONDITIONS),
    "BaseType":     FieldDef("BaseType",     "物品基底",   FieldType.STRING,  SECTION_CONDITIONS),
...
ACTION_SCHEMA: dict[str, FieldDef] = {
    "SetTextColor":       FieldDef("SetTextColor",       "文字顏色",     FieldType.COLOR,      SECTION_APPEARANCE),
    "SetBackgroundColor": FieldDef("SetBackgroundColor", "背景顏色",     FieldType.COLOR,      SECTION_APPEARANCE),
    "SetBorderColor":     FieldDef("SetBorderColor",     "邊框顏色",     FieldType.COLOR,      SECTION_APPEARANCE),
    "SetFontSize":        FieldDef("SetFontSize",        "字體大小",     FieldType.INT,        SECTION_APPEARANCE, 1, 45),
    ...
    "PlayAlertSound":     FieldDef("PlayAlertSound",     "警報音效",     FieldType.SOUND_ID,   SECTION_AUDIO,    0, 16),
    "PlayAlertSoundPositional": FieldDef("PlayAlertSoundPositional","定位音效",FieldType.SOUND_ID,SECTION_AUDIO,0,16),
    "CustomAlertSound":   FieldDef("CustomAlertSound",  "自訂音效",     FieldType.CUSTOM_SND, SECTION_AUDIO),
    "CustomAlertSoundOptional": FieldDef("CustomAlertSoundOptional","自訂音效(可選)",FieldType.CUSTOM_SND,SECTION_AUDIO),
    "DisableDropSound":   FieldDef("DisableDropSound",  "停用掉落音",   FieldType.BOOL,       SECTION_AUDIO, options=BOOL_OPTIONS),
    "EnableDropSound":    FieldDef("EnableDropSound",   "啟用掉落音",   FieldType.BOOL,       SECTION_AUDIO, options=BOOL_OPTIONS),
    "DisableDropSoundIfAlertSound": FieldDef("DisableDropSoundIfAlertSound","警報時停用掉落音",FieldType.BOOL,SECTION_AUDIO,options=BOOL_OPTIONS),
    "EnableDropSoundIfAlertSound":  FieldDef("EnableDropSoundIfAlertSound", "警報時啟用掉落音",FieldType.BOOL,SECTION_AUDIO,options=BOOL_OPTIONS),
}
